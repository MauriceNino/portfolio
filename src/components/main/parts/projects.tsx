...
export default function Projects(props: any) {
    ...
    return (<>
        ...
        <div id={styles.projectsFlex}>
            ...
            <SingleProject title="Q-Help" logo={{class: 'qhelp', img: qhelpLogo, logoLeft: true}} isFullscreen={isFullscreen}>
            ...
            <SingleProject title="GamerPals" logo={{class: 'gamerpals', img: gamerpalsLogo, logoLeft: false}} isFullscreen={isFullscreen}>
            ...
            <SingleProject title="More" logo={{class: 'more', img: moreLogo, logoLeft: true}} isFullscreen={isFullscreen}>
